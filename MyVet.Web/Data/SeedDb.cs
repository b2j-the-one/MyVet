...
namespace MyVet.Web.Data
{
    public class SeedDb
    {
        ...
        private async Task CheckServiceTypesAsync()
        {
            ...
            {
                _dataContext.ServiceTypes.Add(new ServiceType { Name = "Consultation" });
                _dataContext.ServiceTypes.Add(new ServiceType { Name = "Urgence" });
                _dataContext.ServiceTypes.Add(new ServiceType { Name = "Vaccination" });
                await _dataContext.SaveChangesAsync();
            }
        }
